...
totalinventories<- fredr(series_id= "AMTMTI", observation_start = as.Date("2011-01-01"))

#plot
plot_totalinventories<- ggplot(totalinventories,aes(x=date, y=value,)) + 
  geom_line(color="#4f86f7") + labs(title = "Manufacturers' Total Inventories: Total Manufacturing", x="Date", 
