...
shipments<- fredr(series_id= "AMTMVS", observation_start = as.Date("2011-01-01"))

#plot
plot_shipments<- ggplot(shipments,aes(x=date, y=value,)) + 
  geom_line(color="#4f86f7") + labs(title = "Manufacturers' Value of Shipments: Total Manufacturing", x="Date", 
